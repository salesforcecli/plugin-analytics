...
export default class Create extends SfdxCommand {
  public static description = messages.getMessage('objectsCommandDescription');
  public static longDescription = messages.getMessage('objectsCommandLongDescription');

  public static examples = ['$ sfdx analytics:cdp:objects:create -d dataOrgInstance -i dataOrgId'];
  ...
  public async run() {
    ...
    const results = await authSvc.create(
      'CreateObjects',
      this.flags.dataorgid as string,
      this.flags.dataorginstance as string
    );
